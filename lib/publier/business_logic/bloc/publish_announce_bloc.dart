...
class PublishAnnonceBloc
    extends Bloc<PublishAnnonceEvent, PublishAnnonceState> {
  final PublishService _publishService;

  PublishAnnonceBloc(this._publishService)
      : super(PublishAnnonceInitial() as PublishAnnonceState) {
